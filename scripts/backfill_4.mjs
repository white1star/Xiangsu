...
//
// ⚠️ 回滚说明（2026-07-31）：用户确认本批次有 6 条超出「智能干选/XRT 设备采购与中标」核心，
//   属维保/维修/EPC/排矸机器人/机械选矸等周边产品线，已删除。当前仅保留 3 条合规核心条目：
//   中振建设(智能选矸设备采购)、天顺矿业(智能干选机购置)、东庞矿北井(干式智能选煤设备)。
//   本脚本【不可再次重跑】，否则会把已回滚的 6 条重新写入。如需重跑请先移除下方 ADD 中对应 6 条。
