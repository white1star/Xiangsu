...
function projKey(title) {
  ...
  s = s.replace(/（重新公告）|重新公告|重新招标|变更公告|\[?询比价采购\]?/g, '');
  // 循环剥离阶段后缀
...
const HINTS = [
  ...
  [/雷波.*小沟磷矿.*光电分选机/, 'HINT::雷波小沟磷矿光电分选机'],
  [/石头梅.*选矸加工服务/, 'HINT::石头梅830煤场选矸加工'],
  [/天顺矿业.*设备购置.*第四批/, 'HINT::新疆天顺设备购置第四批'],
